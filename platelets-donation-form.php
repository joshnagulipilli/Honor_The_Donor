...
<body>
    <div class="bd-content">
        <h2 style="display: flex; align-items: center; justify-content: center; margin-top:20px">Platelets Donation Form</h2>
        <div class="bd-formdiv">
            
            <form action="platelets-donation-form.php" method="post" enctype="multipart/form-data"  style="padding-top:50px ; padding-bottom: 50px;">
                ...
                <div class="bd-form-row">
                    ...
                    <div class="bd-form-col col-lg-6" >
                        <button type="submit" name="donate-platelets" class="btn btn-primary" style="background-color: red ; border:2px solid red ;width: 100px; box-shadow:0 0 10px black; margin-top:25px; margin-left:220px;">SUBMIT</button>
                    </div>
                </div>
...
<?php
    // session_start();
    if(isset($_POST['donate-platelets'])){
        $age=$_POST['age'];
        $units=$_POST['units'];
        ...
        $query= "insert into `platelets-donation-form` (username,age,units,bloodgrp,number,recent,weight,address,reports) values ('$username','$age','$units','$group','$number','$recent','$weight','$address','$destination')";
