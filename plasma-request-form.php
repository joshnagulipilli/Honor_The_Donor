...
<body>
    <div class="bd-content">
        <h2 style="display: flex; align-items: center; justify-content: center; margin-top:20px">Plasma Request Form</h2>
        <div class="bd-formdiv">
            
            <form action="plasma-request-form.php" method="post" enctype="multipart/form-data"   style="padding-top:50px ; padding-bottom: 50px;">
                ...
                <div class="bd-form-row">
                    ...
                    <div class="bd-form-col col-lg-6" >
                        <button type="submit" name="request-plasma" class="btn btn-primary" style="background-color: red ; border:2px solid red ;width: 100px; box-shadow:0 0 10px black; margin-top:25px; margin-left:220px;">SUBMIT</button>
                    </div>
                </div>
            </form>
        </div>
...
echo "ki";
$query= "insert into `plasma-request-form` (username,name,age,units,bloodgrp,num,weight,address,reports) values ('$username','$name','$age','$units','$group','$number','$weight','$address','$destination')";
