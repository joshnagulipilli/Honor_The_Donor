...
<body>
    <div class="requests-main-div">
        ...
        <?php 
          ...
          $query = "SELECT * FROM `blood-request-rejected` WHERE username='$username'";
        ...
        <?php 
          require("config.php");
          $username=$_SESSION['UserId'];
          $query = "SELECT * FROM `plasma-request-rejected` WHERE username='$username'";
          $query_run = mysqli_query($con,$query);
          $check= mysqli_num_rows($query_run);
          if($check){
            while($row = mysqli_fetch_array($query_run))
        ...
        <?php 
          require("config.php");
          $username=$_SESSION['UserId'];
          $query = "SELECT * FROM `platelets-request-rejected` WHERE username='$username'";
          $query_run = mysqli_query($con,$query);
          $check= mysqli_num_rows($query_run);
          if($check){
            while($row = mysqli_fetch_array($query_run))
