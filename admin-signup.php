    ...
    <div class="mainblood-form">
        <div class="donorblood-form">
            ...
            <form action="admin-signup.php" method="post">
                ...
                <div class="form-row">
                    <input type="submit" name="admin-signup" class="btn btn-primary" style="background-color: red ; border:2px solid red ;width: 150px; box-shadow:0 0 10px black; " value="Sign Up">
                </div>
            </form>
        </div>
    </div>
...
<?php
    if(isset($_POST['admin-signup'])){
        ...
        if($password!=$check){
            ...
            $sql="select * from `admin_registration` where (username='$username' or email= '$email');";
            ...
            if(mysqli_num_rows($res) > 0){
                ...
                $query= "INSERT INTO `admin_registration`( `fullname`, `username`, `email`, `num`, `password`) VALUES ('$fname','$username','$email','$num','$password')";
