...
<div class="requests-main-div">
        ...
        <?php 
          ...
          $query = "SELECT * FROM `blood-donation-approved` WHERE username='$username'";
        ...
        <?php 
          require("config.php");
          $username=$_SESSION['UserId'];
          $query = "SELECT * FROM `plasma-donation-approved` WHERE username='$username'";
          $query_run = mysqli_query($con,$query);
          $check= mysqli_num_rows($query_run);
          if($check){
            while($row = mysqli_fetch_array($query_run))
        ...
        <?php 
          require("config.php");
          $username=$_SESSION['UserId'];
          $query = "SELECT * FROM `platelets-donation-approved` WHERE username='$username'";
          $query_run = mysqli_query($con,$query);
          $check= mysqli_num_rows($query_run);
          if($check){
            while($row = mysqli_fetch_array($query_run))
