...
<body>
    <div class="bd-content">
        <h2 style="display: flex; align-items: center; justify-content: center; margin-top:20px">Blood Donation Form</h2>
        <div class="bd-formdiv">
            
            <form action="blood-donation-form.php" method="post" enctype="multipart/form-data" style="padding-top:50px ; padding-bottom: 50px;">
                ...
                <div class="bd-form-row">
                    <div class="bd-form-col col-lg-6">
                        ...
                        <select name="recent-blood"   id="" style="position: relative;width: 90%; padding:0 10px; padding-right: 10px;  margin: 0 5%;height: 50%;"> 
                            ...
                            <option value="less than 2months ">Less Than 2 Months</option>
                ...
                <div class="bd-form-row">
                    ...
                    <div class="bd-form-col col-lg-6" >
                        ...
                        <button type="submit" name="donate-blood" class="btn btn-primary" style="background-color: red ; border:2px solid red ;width: 100px; box-shadow:0 0 10px black; margin-top:25px; margin-left:220px;">SUBMIT</button>
                    </div>
                </div>
...
<?php
    ...
    if(isset($_POST['donate-blood'])){
        ...
        $query= "insert into `blood-donation-form` (username,age,units,bloodgrp,number,recent,weight,address,reports) values ('$username','$age','$units','$group','$number','$recent','$weight','$address','$destination')";
